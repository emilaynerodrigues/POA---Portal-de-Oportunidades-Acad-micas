<form id="formAtualizarSenha" action="../../php/anunciante/script_atualizarSenha.php" method="post">
    <!-- input de email - apenas de leitura -->
    <div class="form-item">
        <input type="email" name="email" id="emailCandidato-input" class="emailCandidato-input" autocomplete="email" value="<?php echo $email_anunciante ?>" readonly />
